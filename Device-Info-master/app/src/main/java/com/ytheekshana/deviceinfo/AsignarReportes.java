...
public class AsignarReportes extends AppCompatActivity {
    ...
    private void llenarSpinnerEvaluador() {
        String url="http://192.168.101.2/proyecto/retrievevaluadorr.php";
    ...
    private void llenarSpinnerAplicacion() {
        String url="http://192.168.101.2/proyecto/retrieveaplicacionn.php";
        cliente.post(url, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (statusCode==200){
    ...
    private void insertData() {
        ...
        BuscarIdSpinner("http://192.168.101.2/proyecto/buscaraplicacionn.php?nombre="+tipoaplicacion);
        BuscarIdSpinnerEvaluador(" http://192.168.101.2/proyecto/buscarevaluador.php?nombre="+tipoevaluador);
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.101.2/proyecto/insertarAsignarReportes.php",
