...
public class Select_Apk extends AppCompatActivity {
    ...
    String url = "http://192.168.1.41/proyecto/retrieveevaluadorapk.php";
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.41/proyecto/deleteevaluador.php",
