...
public class Select_Apk extends AppCompatActivity {
    ...
    String url = "http://192.168.1.71/proyecto/retrieveevaluadorapk.php";
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        switch (i){
                            ...
                            case 0:
                                ...
                                startActivity(new Intent(getApplicationContext(),SplashActivity.class)//Eficienciados
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.71/proyecto/deleteevaluador.php",
