...
public class DatosAplicativo extends AppCompatActivity {
    ...
    private  void llenarSpinner(){
        String url="http://192.168.1.71/proyecto/retrieveaplicacion.php";
    ...
    private void insertData() {
        ...
        BuscarIdSpinner("http://192.168.1.71/proyecto/buscaraplicacion.php?tipoaplicativo="+tipo);
        ...
        if(nombre.isEmpty()){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.71/proyecto/insertardatosaplicacion.php",
