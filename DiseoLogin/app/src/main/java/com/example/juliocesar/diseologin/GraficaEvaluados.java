...
public class GraficaEvaluados extends AppCompatActivity {
    ...
    //Eje Y
    private Float [] sale=new Float[] {Graficaresultados.feficiencia,Graficaresultados.feficacia,Graficaresultados.fmemorabilidad,Graficaresultados.fproductividad,Graficaresultados.fsatisfaccion,Graficaresultados.fseguridad,Graficaresultados.funiversabilidad,Graficaresultados.fcargacognitiva};
