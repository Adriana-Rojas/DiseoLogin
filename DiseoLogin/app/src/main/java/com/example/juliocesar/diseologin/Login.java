        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!usuario1.isEmpty()&&!password1.isEmpty()){
                    validarUsuario("http://192.168.101.2/proyecto/validar_usuario.php");
                }
            }
        });
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.isEmpty()){
                    ...
                    validarEvaluador("http://192.168.101.2/proyecto/validar_evaluador.php");
                }
            }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.isEmpty()){
                    ...
                    validarAdministrador("http://192.168.101.2/proyecto/validar_administrador.php");
                }
            }
        }, new Response.ErrorListener() {
            @Override
