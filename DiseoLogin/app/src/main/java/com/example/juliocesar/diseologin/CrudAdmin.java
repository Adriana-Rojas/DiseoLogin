...
public class CrudAdmin extends AppCompatActivity {
    ...
    String url = "http://192.168.1.113/proyecto/retrieveadmin.php";
    Employee employee;
    @Override
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.113/proyecto/deleteadmin.php",
